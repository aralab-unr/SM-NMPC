...
{
acadoWorkspace.H[(iRow * 160) + (iCol * 4)] = (real_t)1.0000000000000001e-01;
...
acadoWorkspace.H[(iRow * 160 + 40) + (iCol * 4 + 1)] = (real_t)3.5000000000000000e+01;
...
acadoWorkspace.H[(iRow * 160 + 80) + (iCol * 4 + 2)] = (real_t)3.5000000000000000e+01;
...
acadoWorkspace.H[(iRow * 160 + 120) + (iCol * 4 + 3)] = (real_t)3.5000000000000000e+01;
}
...
dNew[1] = 0.0;
;
dNew[2] = + (real_t)3.5500000000000000e+01*dOld[2];
...
RDy1[1] = + (real_t)3.5000000000000000e+01*Dy1[5];
RDy1[2] = + (real_t)3.5000000000000000e+01*Dy1[6];
RDy1[3] = + (real_t)3.5000000000000000e+01*Dy1[7];
}
...
QDy1[1] = 0.0;
;
QDy1[2] = + (real_t)3.5500000000000000e+01*Dy1[0];
...
Gx2[23] = 0.0;
;
Gx2[24] = + (real_t)3.5500000000000000e+01*Gx1[24];
Gx2[25] = + (real_t)3.5500000000000000e+01*Gx1[25];
Gx2[26] = + (real_t)3.5500000000000000e+01*Gx1[26];
Gx2[27] = + (real_t)3.5500000000000000e+01*Gx1[27];
Gx2[28] = + (real_t)3.5500000000000000e+01*Gx1[28];
Gx2[29] = + (real_t)3.5500000000000000e+01*Gx1[29];
Gx2[30] = + (real_t)3.5500000000000000e+01*Gx1[30];
Gx2[31] = + (real_t)3.5500000000000000e+01*Gx1[31];
Gx2[32] = + (real_t)3.5500000000000000e+01*Gx1[32];
Gx2[33] = + (real_t)3.5500000000000000e+01*Gx1[33];
Gx2[34] = + (real_t)3.5500000000000000e+01*Gx1[34];
Gx2[35] = + (real_t)3.5500000000000000e+01*Gx1[35];
...
Gu2[7] = 0.0;
;
Gu2[8] = + (real_t)3.5500000000000000e+01*Gu1[8];
Gu2[9] = + (real_t)3.5500000000000000e+01*Gu1[9];
Gu2[10] = + (real_t)3.5500000000000000e+01*Gu1[10];
Gu2[11] = + (real_t)3.5500000000000000e+01*Gu1[11];
...
acadoWorkspace.lb[0] = (real_t)1.5500000000000000e+01 - acadoVariables.u[0];
...
acadoWorkspace.lb[4] = (real_t)1.5500000000000000e+01 - acadoVariables.u[4];
...
acadoWorkspace.lb[8] = (real_t)1.5500000000000000e+01 - acadoVariables.u[8];
...
acadoWorkspace.lb[12] = (real_t)1.5500000000000000e+01 - acadoVariables.u[12];
...
acadoWorkspace.lb[16] = (real_t)1.5500000000000000e+01 - acadoVariables.u[16];
...
acadoWorkspace.lb[20] = (real_t)1.5500000000000000e+01 - acadoVariables.u[20];
...
acadoWorkspace.lb[24] = (real_t)1.5500000000000000e+01 - acadoVariables.u[24];
...
acadoWorkspace.lb[28] = (real_t)1.5500000000000000e+01 - acadoVariables.u[28];
...
acadoWorkspace.lb[32] = (real_t)1.5500000000000000e+01 - acadoVariables.u[32];
...
acadoWorkspace.lb[36] = (real_t)1.5500000000000000e+01 - acadoVariables.u[36];
...
acadoWorkspace.ub[0] = (real_t)2.1500000000000000e+01 - acadoVariables.u[0];
...
acadoWorkspace.ub[4] = (real_t)2.1500000000000000e+01 - acadoVariables.u[4];
...
acadoWorkspace.ub[8] = (real_t)2.1500000000000000e+01 - acadoVariables.u[8];
...
acadoWorkspace.ub[12] = (real_t)2.1500000000000000e+01 - acadoVariables.u[12];
...
acadoWorkspace.ub[16] = (real_t)2.1500000000000000e+01 - acadoVariables.u[16];
...
acadoWorkspace.ub[20] = (real_t)2.1500000000000000e+01 - acadoVariables.u[20];
...
acadoWorkspace.ub[24] = (real_t)2.1500000000000000e+01 - acadoVariables.u[24];
...
acadoWorkspace.ub[28] = (real_t)2.1500000000000000e+01 - acadoVariables.u[28];
...
acadoWorkspace.ub[32] = (real_t)2.1500000000000000e+01 - acadoVariables.u[32];
...
acadoWorkspace.ub[36] = (real_t)2.1500000000000000e+01 - acadoVariables.u[36];
...
;
acadoWorkspace.QDy[122] = + (real_t)5.0000000000000000e-01*acadoWorkspace.DyN[0];
acadoWorkspace.QDy[123] = + (real_t)5.0000000000000000e-01*acadoWorkspace.DyN[1];
acadoWorkspace.QDy[124] = + (real_t)5.0000000000000000e-01*acadoWorkspace.DyN[2];
acadoWorkspace.QDy[125] = + (real_t)5.0000000000000000e-01*acadoWorkspace.DyN[3];
...
for (lRun1 = 0; lRun1 < 10; ++lRun1)
{
tmpDy[0] = + acadoWorkspace.Dy[lRun1 * 8]*(real_t)3.5500000000000000e+01;
...
tmpDy[4] = + acadoWorkspace.Dy[lRun1 * 8 + 4]*(real_t)1.0000000000000001e-01;
tmpDy[5] = + acadoWorkspace.Dy[lRun1 * 8 + 5]*(real_t)3.5000000000000000e+01;
tmpDy[6] = + acadoWorkspace.Dy[lRun1 * 8 + 6]*(real_t)3.5000000000000000e+01;
tmpDy[7] = + acadoWorkspace.Dy[lRun1 * 8 + 7]*(real_t)3.5000000000000000e+01;
