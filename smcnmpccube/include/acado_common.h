...
/** Matrix of size: 12 x 5 (row major format)
 * 
 ...
 * 
 *  Matrix containing 12 reference/measurement vectors of size 9 for first 12 nodes.
 */
real_t y[ 108 ];
...
/** Matrix of size: 3 x 216 (row major format) */
real_t rk_kkk[ 648 ];
...
/** Matrix of size: 144 x 5 (row major format) */
real_t evGu[ 720 ];
...
/** Matrix of size: 936 x 5 (row major format) */
real_t E[ 4680 ];
